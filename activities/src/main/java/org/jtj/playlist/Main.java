...
public class Main {
    public static void main(String[] args) {
        ...
        // Add some songs to the album
        album.addSong("Bohemian Rhapsody", 6.00);
        album.addSong("Another One Bites the Dust", 3.36);
        album.addSong("We Will Rock You", 2.02);

        // Create a playlist
        LinkedList<Song> playlist = new LinkedList<>();

        // Add songs to the playlist using track numbers
        album.addToPlayList(1, playlist); // Bohemian Rhapsody
        album.addToPlayList(3, playlist); // We Will Rock You
        album.addToPlayList(5, playlist); // No song at track 5, so it won't be added

        // Add a song to the playlist using title
        album.addToPlayList("Another One Bites the Dust", playlist);
