...
public class Main {
    public static void main(String[] args) {
        ...
        // Adding contacts
        mobilePhone.addNewContact(Contact.createContact("Bob", "9123456789"));
        mobilePhone.addNewContact(Contact.createContact("Alice", "123456789"));
        mobilePhone.addNewContact(Contact.createContact("Tom", "456789123"));
        mobilePhone.addNewContact(Contact.createContact("Jane", "321564978"));
        mobilePhone.addNewContact(Contact.createContact("Juan", "98765431"));
        // Print
        mobilePhone.printContacts();

        // Query
        String queryName = "Jane";
        Contact queriedContact = mobilePhone.queryContact(queryName);
        System.out.println("Name: " + queriedContact.getName());
        System.out.println("Phone Number: " + queriedContact.getPhoneNumber());

        System.out.println("----------------");
        //Updating
        Contact oldContact = Contact.createContact("Juan", "98765431");
        Contact newContact = Contact.createContact("Juan", "123123123");
