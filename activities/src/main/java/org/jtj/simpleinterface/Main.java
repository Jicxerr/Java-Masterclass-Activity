...
public class Main {
    public static void main(String[] args) {
        ...
        // Modify player and monster state (for example)
        player.setHitPoints(90);
        monster.setStrength(35);

        // Display modified state
        System.out.println("\nModified Player:");
        System.out.println(player);
        System.out.println("Modified Monster:");
        System.out.println(monster);

        // Reload player and monster state
        player.read(playerData);
        monster.read(monsterData);

        // Display reloaded state
        System.out.println("\nReloaded Player:");
        System.out.println(player);
        System.out.println("Reloaded Monster:");
        System.out.println(monster);
    }
}
