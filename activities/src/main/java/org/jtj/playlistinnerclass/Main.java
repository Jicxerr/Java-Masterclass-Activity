package org.jtj.playlistinnerclass;
...
public class Main {
    public static void main(String[] args) {
        ...
        album.addToPlayList(1, playlist); // Add first song
        album.addToPlayList(2, playlist); // Add second song
        album.addToPlayList(5, playlist); // Try to add non-existent song

        // Add songs to the playlist by title
        album.addToPlayList("Song 3", playlist); // Add third song
        album.addToPlayList("Song 4", playlist); // Try to add non-existent song
